 ...
 */
package com.kakaoprices.controller;
...
@Controller
public class KakaopricesHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", kakaopricesService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
