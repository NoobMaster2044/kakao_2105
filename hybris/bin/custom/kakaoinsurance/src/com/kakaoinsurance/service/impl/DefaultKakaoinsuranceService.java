...
public class DefaultKakaoinsuranceService implements KakaoinsuranceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultKakaoinsuranceService.class);
	...
	{
		return DefaultKakaoinsuranceService.class.getResourceAsStream("/kakaoinsurance/sap-hybris-platform.png");
	}
