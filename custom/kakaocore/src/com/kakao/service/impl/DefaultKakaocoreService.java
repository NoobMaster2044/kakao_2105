...
public class DefaultKakaocoreService implements KakaocoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultKakaocoreService.class);
	...
	{
		return DefaultKakaocoreService.class.getResourceAsStream("/kakaocore/sap-hybris-platform.png");
	}
