...
public class DefaultKakaopricesService implements KakaopricesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultKakaopricesService.class);
	...
	{
		return DefaultKakaopricesService.class.getResourceAsStream("/kakaoprices/sap-hybris-platform.png");
	}
