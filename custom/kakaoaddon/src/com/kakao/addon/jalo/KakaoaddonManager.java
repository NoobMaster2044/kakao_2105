...
import com.kakao.addon.constants.KakaoaddonConstants;



/**
 * This is the extension manager of the Kakaoaddon extension.
 */
public class KakaoaddonManager extends GeneratedKakaoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(KakaoaddonManager.class.getName());
	 ...
	 */
	public static KakaoaddonManager getInstance()
	{
		return (KakaoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				KakaoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KakaoaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KakaoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of KakaoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of KakaoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
